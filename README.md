...
├── flaskapp.wsgi                   # Apache/mod_wsgi entrypoint
├── apps/                           # Core modular package (each submodule = blueprint)
│   ├── __init__.py                 # App factory; registers all blueprints
│   │
│   ├── categories/                 # Module 3: Categories
│   │   ├── __init__.py
│   │   ├── routes.py
│   │   └── models.py
│   ├── uom/                        # Module 5: Units of Measure
│   │   ├── __init__.py
│   │   ├── routes.py               # Minimal blueprint route for testing
│   │   └── models.py               # Empty for now
│   └── utils/                      # Shared utilities across modules
│       ├── __init__.py
│       └── helpers.py              # Markdown rendering, formatting, etc.
├── templates/                      # Global templates (all modules share this folder)
│   ├── base.html                   # Base layout (header/footer, extends for pages)
│   ├── 404.html                    # Optional: error page
│   ├── categories/
│   │   └── index.html
│   └── uom/
│       └── index.html              # Moved here from apps/uom/templates for base.html access
