# /home/user/Public/web/dbpilot/apps/uom/views.py
from django.contrib.auth.decorators import login_required  # <-- Authentican login/logout
import sqlite3
...
@login_required             # <-- Authentican login/logout
def index(request):
    ...
    return render(request, 'uom/index.html', {
        ...
        'records': records,
        'tables': tables,            # all stock* tables
        'current_table': 'stock_items_uom',  # for the selector
    })
