...
from django.conf.urls.static import static  # PDFview 
...
urlpatterns = [
    ...
    path('taskjson/', include('apps.taskjson.urls')),              # Task app using JSON
...
] + static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)  # Serve media files (e.g., PDFs, images) during development
